...
out=Figure2AGU2024 #Output file name
...
gmt basemap -R$region_trace -Bpya1f0.5+l"Station @[\Delta@[X (PS71) [m]" -BWS -Bpxa2Df12h+l"Date" -Yh+2.5c -JX16c/10c
...
2013-01-26T04:00:00 6 Threshold
EOF

gmt text -R$region_res -F+f18,Helvetica,33/49/77 <<EOF
2013-01-25T06:00:00 32 Events
EOF
